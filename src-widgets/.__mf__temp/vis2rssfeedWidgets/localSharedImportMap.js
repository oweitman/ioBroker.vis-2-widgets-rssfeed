...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "react": async () => {
          let pkg = await import("__mf__virtual/vis2rssfeedWidgets__prebuild__react__prebuild__.js")
          return pkg
        }
      ,
        "react-dom": async () => {
      ...
      ,
        "@iobroker/adapter-react-v5": async () => {
          let pkg = await import("__mf__virtual/vis2rssfeedWidgets__prebuild___mf_0_iobroker_mf_1_adapter_mf_2_react_mf_2_v5__prebuild__.js")
          return pkg
        }
      ,
