...
class DemoWidget extends (window.visRxWidget || VisRxWidget) {
    static getWidgetInfo() {
        return {
            id: 'tplDemoWidget',
            visSet: 'vis_2_rssfeed',
            visSetLabel: 'vis_2_widgets_template', // Widget set translated label (should be defined only in one widget of set)
            //            visSetColor: 'orange',                // Color of widget set. it is enough to set color only in one widget of set
            visName: 'DemoWidget abc',                 // Name of widget
            visAttrs: [
                {
            ...
            visPrev: 'widgets/vis-2-widgets-rssfeed/img/rssfeed.png',
        };
    }
